...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-11">
            ...
            <!-- category -->
            <br><hr><hr><br>
            <u class="h1"><i class="fas fa-bolt"></i> -category- </u>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="card m-1 card-height shadow-sm">
                            ...
                            @if ($article->category_id != null)
                                <a href="{{ action('Admin\CategoryController@index', ['id' => $article->category_id]) }}"><span class="badge badge-secondary p-2"><i class="fas fa-bolt"></i> {{ $article->category->name }}</span></a>
                            @endif
                            <div class="card-body">
